...
async def test_load_scenarios(*, loader: TestCaseLoader, tmp_scn_dir: Path):
    with given:
        ...
        path.write_text(dedent('''
            ...
            class MyChildTestCase(MyBaseTestCase):
...
async def test_run_passed_tests(*, loader: TestCaseLoader, tmp_scn_dir: Path,
...
async def test_run_failed_tests(*, loader: TestCaseLoader, tmp_scn_dir: Path,
                                dispatcher: Dispatcher):
    with given:
        path = tmp_scn_dir / "scenario.py"
        path.write_text(dedent('''
