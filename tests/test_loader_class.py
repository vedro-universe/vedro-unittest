...
async def test_load_scenario(*, provider: Provider, tmp_scn_dir: Path):
    ...
    with then:
        ...
        assert scenarios[0].name == "Scenario_TestCase"
        assert scenarios[0].subject == "All tests in class 'TestCase'"
...
async def test_class_setup(*, provider: Provider, tmp_scn_dir: Path, dispatcher: Dispatcher):
    with given:
        tmp_file = tmp_scn_dir / "tmp_file.txt"
...
async def test_class_teardown(*, provider: Provider, tmp_scn_dir: Path, dispatcher: Dispatcher):
    with given:
        tmp_file = tmp_scn_dir / "tmp_file.txt"
...
async def test_class_cleanup(*, provider: Provider, tmp_scn_dir: Path, dispatcher: Dispatcher):
    with given:
        tmp_file = tmp_scn_dir / "tmp_file.txt"
